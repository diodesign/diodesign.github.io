...
For more information about how the website is built, see its [README](https://github.com/diodesign/diodesign.github.io/blob/prod/README.md).

### Lab projects

To contribute to an [ongoing lab project](/about/), refer to that project's contribution guidelines and licensing. If you have an idea for a new project, send an [email to Chris](/contact/) with your proposal.
